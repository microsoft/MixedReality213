    ...
    public class SplineInspector : LineBaseInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(" + Add Points to Start"))
            {
                ...
                List<Spline.SplinePoint> points = new List<Spline.SplinePoint>();
                Spline.SplinePoint[] newPoints = new Spline.SplinePoint[3];
            ...
            if (GUILayout.Button(" - Remove Points from Start")) {
                ...
                List<Spline.SplinePoint> points = new List<Spline.SplinePoint>(s.Points);
